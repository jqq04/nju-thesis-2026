...
\englishabstracttitlea{Design and Implementation of a }
% 设置英文摘要页面的论文标题及副标题的第二行。
% 此属性可选，其默认值为空白
\englishabstracttitleb{Content Application and Management Platform for Advertising and Commercial Scenarios}
...
首先，衷心感谢我的导师刘峰老师在论文选题、研究思路、系统设计与写作修改等方面给予的悉心指导。导师严谨的治学态度、务实的工程视角与耐心的学术训练，使我在研究方法与问题分析能力上受益良多，并为论文的顺利完成提供了关键保障。
