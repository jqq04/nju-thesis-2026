...
% 单行论文标题，不可换行
\title{面向广告业务的内容资产管理平台的设计与实现}

% 如果论文标题过长，可以分两行，第一行用\titlea{}定义，第二行用\titleb{}定义，
% 使用以下3行：
\title{} %用于覆盖单行标题内容为空
\titlea{面向广告业务的}  %第一行标题写这里
\titleb{内容资产管理平台的设计与实现} %第二行标题写这里
...
% 论文的英文标题，不可换行
\englishtitle{Design and Implementation of a Content Asset Management Platform for Advertising Business}
% 论文作者姓名的拼音
...
\abstracttitlea{面向广告业务的}
% 设置中文摘要页面的论文标题及副标题的第二行。
% 此属性可选，其默认值为空白
\abstracttitleb{内容资产管理平台的设计与实现}
...
\englishabstracttitlea{Design and Implementation of a Content Asset}
% 设置英文摘要页面的论文标题及副标题的第二行。
% 此属性可选，其默认值为空白
\englishabstracttitleb{Management Platform for Advertising Business}
